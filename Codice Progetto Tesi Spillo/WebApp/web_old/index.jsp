      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-9  order-md-1">
            <h2 class="heading mb-3">WherEXP</h2>
            <div class="sub-heading"><p class="mb-5">Tu ci dici come vuoi trascorrere la giornata, noi pensiamo al resto.</p></div>
            <p><a href="sceltaContesti.jsp" role="button" class="btn smoothscroll pb_outline-light rounded-0 btn-xl pb_font-13 pb_letter-spacing-2 p-3">Inizia ora</a></p>
